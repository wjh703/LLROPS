...
def catalog_create(config: dict, context: RunContext):
    from llrops.fileio.builtin_catalogs import REFLECTORS, STATIONS
    from llrops.fileio.catalogs import write_reflector_catalog, write_station_catalog
...
def llr_apply_solution(config: dict, context: RunContext):
    from llrops.fileio.catalogs import read_reflector_catalog, write_reflector_catalog
    from llrops.fileio.parameters import read_parameter_vector
    from llrops.fileio.structured_text import write_structured_text
