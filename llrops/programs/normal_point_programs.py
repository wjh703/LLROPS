...
def normal_points_convert(config: dict, context: RunContext):
    from llrops.fileio.normal_point_file import write_normal_point_file
...
def normal_points_filter(config: dict, context: RunContext):
    ...
    from llrops.fileio.normal_points import NptDataset, parse_time_filter
...
def normal_points_statistics(config: dict, context: RunContext):
    ...
    from llrops.fileio.normal_point_file import read_normal_point_file
    from llrops.fileio.structured_text import write_structured_text
